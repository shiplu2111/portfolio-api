...
>
    @if ($label)
        <div
            ...
            @endif
            @class([
                'fi-sidebar-group-button flex items-center gap-x-3 px-2 py-0',
        ...
        >
            <x-slot name="trigger">
                <button
                    ...
                    class="relative flex flex-1 items-center justify-center gap-x-3 rounded-lg px-2 py-0 outline-none transition duration-75 hover:bg-gray-100 focus-visible:bg-gray-100 dark:hover:bg-white/5 dark:focus-visible:bg-white/5"
                >
                    <x-filament::icon
                        :icon="$icon"
                        @class([
