...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('header_texts', function (Blueprint $table) {
            ...
            $table->string('client_sub_title');
            $table->string('faq_title');
            $table->string('faq_sub_title');
            $table->string('education_title');
            $table->string('education_sub_title');
            $table->string('experiance_title');
            $table->string('experiance_sub_title');
            $table->string('certificate_title');
            $table->string('certificate_sub_title');
            $table->string('training_title');
            $table->string('training_sub_title');
            $table->string('social_title');
            $table->string('social_sub_title');
